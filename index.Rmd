...
### Campaña 1 {.value-box}
```{r}
valueBox(("Clase 4: Contaminación incipiente"), 
         caption = "Indice Holandes - Campaña 1 (Agosto 2019)", 
         icon = icono_camp_1, 
         color = color_camp_1
         )
```
...
```{r}
valueBox(("N/A"), 
         caption = "Indice Holandes - Campaña 2 (Noviembre 2019)",
         icon = icono_camp_2, 
         color = color_camp_2
         )
```
...
```{r}
valueBox(("N/A"), 
         caption = "Indice Holandes - Campaña 3 (Febrero 2020)",
         icon = icono_camp_3, 
         color = color_camp_3
         )
```
...
```{r}
valueBox(("N/A"), 
         caption = "Indice Holandes - Campaña 4 (Mayo 2020)",
         icon = icono_camp_4, 
         color = color_camp_4
         )
```

...
```{r}
knitr::kable(
  archivo_datos_PNM[1:4, 18:24 ], caption = '**Utilizando el Índice Holandes y el Índice Biológico (BMWP-CR), según el Decreto Ejecutivo N°33903-MINAE-S**'
)
```
